...
public class User_01_Register {
	...
	public void TC_02_Register_Invalid_Email() {
		...
		driver.findElement(By.cssSelector("input#Email")).sendKeys("123@456!@3");
	...
	public void TC_05_Register_Password_Less_Than_6_Chars() {
		...
		Assert.assertEquals(driver.findElement(By.cssSelector("#Password-error"))
	...
	public void TC_06_Register_Invalid_Confirm_Password() {
		...
		Assert.assertEquals(driver.findElement(By.cssSelector("#ConfirmPassword-error"))
